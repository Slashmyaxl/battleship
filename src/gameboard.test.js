...
describe("ship placement", () => {
  ...
  test("vertical placement", () => {
    expect(p1Board.readBoard()[row(2)][column("F")]).toHaveProperty(
      "name",
      "Carrier",
    );
    expect(p1Board.readBoard()[row(3)][column("F")]).toHaveProperty(
      "name",
      "Carrier",
    );
    expect(p1Board.readBoard()[row(4)][column("F")]).toHaveProperty(
      "name",
      "Carrier",
    );
    expect(p1Board.readBoard()[row(5)][column("F")]).toHaveProperty(
      "name",
      "Carrier",
    );
    expect(p1Board.readBoard()[row(6)][column("F")]).toHaveProperty(
      "name",
      "Carrier",
    );
  });
  ...
  test("ship extends only its length", () => {
    expect(p1Board.readBoard()[row(3)][column("A")]).toHaveProperty(
      "name",
      "Battleship",
    );
    expect(p1Board.readBoard()[row(3)][column("B")]).toHaveProperty(
      "name",
      "Battleship",
    );
    expect(p1Board.readBoard()[row(3)][column("C")]).toHaveProperty(
      "name",
      "Battleship",
    );
    expect(p1Board.readBoard()[row(3)][column("D")]).toHaveProperty(
      "name",
      "Battleship",
    );
